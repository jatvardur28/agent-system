...
```json
{{ # <-- ИСПРАВЛЕНО: Двойные скобки
    "agent3_task": {{ # <-- ИСПРАВЛЕНО
...
database.add_or_update_agent( # <-- ПРАВИЛЬНЫЙ ОТСТУП
...
database.add_or_update_agent( # <-- ПРАВИЛЬНЫЙ ОТСТУП
    "agent6_nous0", "Nous_0 (Финальный Аналитик)", "openrouter", "mistralai/mistral-7b-instruct-v0.2",
...
logger.info("Default agents defined and registered in database.") # <-- ПРАВИЛЬНЫЙ ОТСТУП
Запускаем определение агентов при импорте модуля
define_agents() # <-- ПРАВИЛЬНЫЙ ОТСТУП (вызов функции)
